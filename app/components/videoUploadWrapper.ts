...
import video_message_pb, { VideoMessageChunk } from "@/generated/video_message_pb"; // Add this line
import { v4 as uuidv4 } from 'uuid'; // Add this line

declare const uploadVideoMessage: any;

export async function uploadVideo(videoBlob: Blob, metadata: video_message_pb.VideoMessageMetadata): Promise<video_message_pb.VideoMessageMetadata> {
    ...
    const call = uploadVideoMessage(async (err: grpcWeb.RpcError, response: video_message_pb.VideoMessageMetadata) => {
